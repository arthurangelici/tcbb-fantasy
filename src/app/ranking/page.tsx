...
function PlayerRankingCard({ player, currentUser = false }: { player: typeof mockRanking[0], currentUser?: boolean }) {
  return (
...
export default function RankingPage() {
  ...
  const filteredRanking = mockRanking.filter(player => {
  ...
  const topStats = {
    totalPlayers: mockRanking.length,
    averagePoints: Math.round(mockRanking.reduce((acc, p) => acc + p.points, 0) / mockRanking.length),
    averageSuccessRate: Number((mockRanking.reduce((acc, p) => acc + p.successRate, 0) / mockRanking.length).toFixed(1)),
    topPlayer: mockRanking[0]
  }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Veja como você se compara com outros participantes
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <Card>
          <CardContent className="flex items-center p-6">
            ...
            <div>
              <div className="text-2xl font-bold">{topStats.topPlayer.points}</div>
      ...
      {filter === 'all' && (
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-center mb-6">Pódio</h2>
          <div className="flex justify-center items-end space-x-4 mb-8">
            ...
            <div className="text-center">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <div className="text-lg font-semibold">{mockRanking[1].name}</div>
                <div className="text-2xl font-bold text-gray-600">{mockRanking[1].points}</div>
            ...
            <div className="text-center">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg border-2 border-yellow-200">
                <div className="text-lg font-semibold">{mockRanking[0].name}</div>
                <div className="text-2xl font-bold text-yellow-600">{mockRanking[0].points}</div>
            ...
            <div className="text-center">
              ...
              <div className="bg-amber-50 p-4 rounded-lg">
                <div className="text-lg font-semibold">{mockRanking[2].name}</div>
                <div className="text-2xl font-bold text-amber-600">{mockRanking[2].points}</div>
